...
class DarkThemeToggle extends React.Component {
  render() {
    ...
    return (
      <div>
        <Button onClick={() => this.props.dispatch(actions.toggleDarkTheme())}>
...
export default connect(mapStateToProps)(DarkThemeToggle);